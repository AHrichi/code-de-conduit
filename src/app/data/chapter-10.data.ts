  ...
  sections: [
    ...
    },
    {
      ...
      items: [
        ...
        {
          id: 'ch10-r10',
          title: 'الجنح والجرائم المرورية (العقوبات القصوى)',
          description: 'أخطر أنواع الجرائم المرورية وعقوباتها المالية والسجنية:',
          list: [
            'تجاوز السرعة بـ 50 كلم/س فما فوق: خطية 120 إلى 240 د + خصم 4 نقاط.',
            'السياقة في حالة كحولية أو رفض الاختبار: خطية 200 إلى 500 د + سجن 6 أشهر + سحب الرخصة 6 أشهر + خصم 4 نقاط.',
            'الرجوع على الأعقاب في طريق سيارة: خطية 200 إلى 500 د + سجن 6 أشهر + سحب الرخصة 6 أشهر + خصم 4 نقاط.',
            'سياقة عربة غير مسجلة: خطية مالية ثقيلة تصل لـ 3000 د + إيداع بالمستودع البلدي آلياً.',
            'سياقة دون رخصة أو دون الصنف المطلوب: سجن 6 أشهر + خطية 200 إلى 500 د.'
          ],
